...
from enum import StrEnum # Ensure this is imported
...
class Notification(BaseModel):
    id: PyObjectId = Field(default_factory=PyObjectId, alias="_id")
    user_id: str = Field(...)        # The recipient
    title: str = Field(...)          # Short header
    message: str = Field(...)        # Body text
    link: str = Field(...)           # Frontend route to redirect to
